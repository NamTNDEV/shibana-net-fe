...
export function ReactionSelector({ onSelectAction }: ReactionSelectorProps) {
    return (
        <div className="absolute bottom-10 left-1 z-50 flex items-center gap-2 rounded-full bg-white px-3 py-1.5 shadow-lg ring-1 ring-black/5 animate-in slide-in-from-bottom-4 fade-in zoom-in-95 duration-200">
